...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -litemode=<n>          " + strprintf(_("Disable all CONCIERGE specific functionality (Masternodes, Obfuscation, SwiftTX, Budgeting) (0-1, default: %u)"), 0) + "\n";
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i The CONCIERGE Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
