...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51470;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // CONVIERGE starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CONVIERGE: 1 day
        nTargetSpacing = 1 * 60;  // CONVIERGE: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 20;
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "concierge-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "concierge-testnet.seed2.fuzzbawls.pw"));
