                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CNNVIERGE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CNNVIERGE address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CNNVIERGE Core"), this);
    aboutAction->setStatusTip(tr("Show information about CNNVIERGE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CNNVIERGE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CNNVIERGE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CNNVIERGE addresses"));
    ...
    openAction->setStatusTip(tr("Open a CNNVIERGE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CNNVIERGE Core help message to get a list with possible CNNVIERGE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CNNVIERGE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CNNVIERGE network", "", count));
}
...
{
    QString strTitle = tr("CNNVIERGE Core"); // default title
