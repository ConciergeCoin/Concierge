...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a CONVIERGE address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no CONVIERGE: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "CONVIERGE.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for CONVIERGE.lnk
