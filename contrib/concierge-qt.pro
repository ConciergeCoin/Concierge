...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/concierge-cli.cpp \
           src/concierge-tx.cpp \
           src/concierge.cpp \
           src/db.cpp \
           ...
           src/qt/concierge.cpp \
           src/qt/conciergestrings.cpp \
...
RESOURCES += src/qt/concierge.qrc src/qt/concierge_locale.qrc

TRANSLATIONS += src/qt/locale/concierge_bg.ts \
                src/qt/locale/concierge_de.ts \
                src/qt/locale/concierge_en.ts \
                src/qt/locale/concierge_es.ts \
                src/qt/locale/concierge_fi.ts \
                src/qt/locale/concierge_fr.ts \
                src/qt/locale/concierge_it.ts \
                src/qt/locale/concierge_ja.ts \
                src/qt/locale/concierge_pl.ts \
                src/qt/locale/concierge_pt.ts \
                src/qt/locale/concierge_ru.ts \
                src/qt/locale/concierge_sk.ts \
                src/qt/locale/concierge_sv.ts \
                src/qt/locale/concierge_vi.ts \
                src/qt/locale/concierge_zh_CN.ts \
                src/qt/locale/concierge_zh_TW.ts
