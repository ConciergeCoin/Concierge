...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/CONVIERGE-Project/CONVIERGE/blob/master/doc/translation_process.md#synchronising-translations).
...
### CONVIERGE maintainers/release engineers, suggestion for writing release notes
...
### Build and sign CONVIERGE Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [concierge-detached-sigs](https://github.com/CONVIERGE-Project/concierge-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/CONVIERGE-Project/CONVIERGE/releases/new) with a link to the archived release notes.
