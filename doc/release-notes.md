CNNVIERGE Core version 2.2.1 is now available from:
...
CNNVIERGE Core is extensively tested on multiple operating systems using
...
CNNVIERGE Core should also work on most other Unix-like systems but is not
...
of Bitcoin that CNNVIERGE was forked from.
