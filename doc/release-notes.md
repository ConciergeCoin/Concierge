CONVIERGE Core version 2.2.1 is now available from:
...
CONVIERGE Core is extensively tested on multiple operating systems using
...
CONVIERGE Core should also work on most other Unix-like systems but is not
...
of Bitcoin that CONVIERGE was forked from.
