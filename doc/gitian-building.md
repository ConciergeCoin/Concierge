...
*Setup instructions for a gitian build of CNNVIERGE using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the CNNVIERGE
...
- [Building CNNVIERGE](#building-concierge)
...
To build CNNVIERGE (for Linux, OSX and Windows) just follow the steps under 'perform
