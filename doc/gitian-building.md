...
*Setup instructions for a gitian build of CONVIERGE using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the CONVIERGE
...
- [Building CONVIERGE](#building-concierge)
...
To build CONVIERGE (for Linux, OSX and Windows) just follow the steps under 'perform
