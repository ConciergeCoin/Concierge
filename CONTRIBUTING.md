Contributing to CONVIERGE Core
============================

The CONVIERGE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CONVIERGE Core project, and is not to be
confused with overall CONVIERGE Network Protocol consensus changes.

Whether a pull request is merged into CONVIERGE Core rests with the project merge
...
Patches that change CONVIERGE consensus rules are considerably more involved than
...
Where a patch set proposes to change the CONVIERGE consensus, it must have been
...
The project leader is the release manager for each CONVIERGE Core release.
