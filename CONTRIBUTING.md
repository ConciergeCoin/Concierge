Contributing to CONCIERGE Core
============================

The CONCIERGE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CONCIERGE Core project, and is not to be
confused with overall CONCIERGE Network Protocol consensus changes.

Whether a pull request is merged into CONCIERGE Core rests with the project merge
...
Patches that change CONCIERGE consensus rules are considerably more involved than
...
Where a patch set proposes to change the CONCIERGE consensus, it must have been
...
The project leader is the release manager for each CONCIERGE Core release.
