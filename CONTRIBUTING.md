Contributing to CNNVIERGE Core
============================

The CNNVIERGE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CNNVIERGE Core project, and is not to be
confused with overall CNNVIERGE Network Protocol consensus changes.

Whether a pull request is merged into CNNVIERGE Core rests with the project merge
...
Patches that change CNNVIERGE consensus rules are considerably more involved than
...
Where a patch set proposes to change the CNNVIERGE consensus, it must have been
...
The project leader is the release manager for each CNNVIERGE Core release.
